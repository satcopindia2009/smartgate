...
# Visit media retention (stub jobs)
LIVE_PHOTO_RETENTION_DAYS = 90
SIGNATURE_RETENTION_DAYS = 90  # same as live photo (Hub coding default)
ID_IMAGE_RETENTION_DAYS = 30
REJECTED_VISIT_MEDIA_RETENTION_DAYS = 14
VISIT_CONSENT_VERSION_DEFAULT = "visitor_notice_en_hi_v1"
