...
def start_pickup(
    ...
    row = {
        ...
        "attemptedAt": ts,
        "gateUserId": user["id"],
        "pickupConsentAt": (body.pickupConsentAt.strip() if body.pickupConsentAt else None) or None,
        "pickupConsentVersion": (body.pickupConsentVersion.strip() if body.pickupConsentVersion else None) or None,
        "createdAt": ts,
        "updatedAt": ts,
